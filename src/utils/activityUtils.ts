export function calculateActivityPosition(start: number, duration: number, minHour: number = 0, maxHour: number = 24) {
  ...
  export function hasTimeConflict(activity1: { start: number; duration: number }, activity2: { start: number; duration: number }): boolean {
  ...
  export function findAvailableTimeSlot(activities: { start: number; duration: number }[], desiredDuration: number, minHour: number = 6, maxHour: number = 22): number | null {
  ...
  export function validateActivityTime(start: number, duration: number): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
