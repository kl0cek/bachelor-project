...
async function seed() {
    ...
    try {
        ...
        await database_1.AppDataSource.query('TRUNCATE TABLE activities CASCADE');
        await database_1.AppDataSource.query('TRUNCATE TABLE crew_members CASCADE');
        await database_1.AppDataSource.query('TRUNCATE TABLE missions CASCADE');
        await database_1.AppDataSource.query('TRUNCATE TABLE refresh_tokens CASCADE');
        await database_1.AppDataSource.query('TRUNCATE TABLE audit_logs CASCADE');
        await database_1.AppDataSource.query('TRUNCATE TABLE activity_history CASCADE');
        await database_1.AppDataSource.query('TRUNCATE TABLE users CASCADE');
        // Create repositories
        const userRepo = database_1.AppDataSource.getRepository(User_entity_1.User);
        const missionRepo = database_1.AppDataSource.getRepository(Mission_entity_1.Mission);
        const crewRepo = database_1.AppDataSource.getRepository(CrewMember_entity_1.CrewMember);
        const activityRepo = database_1.AppDataSource.getRepository(Activity_entity_1.Activity);
        // 1. Create Users
        ...
        const astronautUser = userRepo.create({
            ...
            role: User_entity_1.UserRole.ASTRONAUT,
            is_active: true,
        });
        ...
        const activeMission = missionRepo.create({
            ...
            description: 'Long-duration spaceflight mission to the International Space Station focusing on scientific research and station maintenance.',
            start_date: new Date('2025-10-15'),
            end_date: new Date('2025-11-07'),
            status: Mission_entity_1.MissionStatus.ACTIVE,
            created_by: operatorUser.id,
        });
        const planningMission = missionRepo.create({
            name: 'Mars Analog Simulation',
            description: 'Ground-based analog mission simulating Mars surface operations for psychological and operational research.',
            start_date: new Date('2024-11-01'),
            end_date: new Date('2025-02-01'),
            status: Mission_entity_1.MissionStatus.PLANNING,
            created_by: operatorUser.id,
        });
        const completedMission = missionRepo.create({
            name: 'Lunar Gateway Simulation',
            description: 'Simulation of lunar orbital operations and surface missions for Artemis program preparation.',
            start_date: new Date('2024-08-01'),
            end_date: new Date('2024-09-30'),
            status: Mission_entity_1.MissionStatus.COMPLETED,
            created_by: operatorUser.id,
        });
        ...
        const day1Activities = [
            // FE-1 Schedule
            {
                ...
                start_hour: 0,
                duration: 6,
                type: Activity_entity_1.ActivityType.SLEEP,
                priority: Activity_entity_1.Priority.HIGH,
            ...
            },
            {
                ...
                duration: 1,
                type: Activity_entity_1.ActivityType.SLEEP,
                priority: Activity_entity_1.Priority.MEDIUM,
                mission: 'Daily Operations',
            ...
            },
            {
                ...
                start_hour: 11,
                duration: 1.5,
                type: Activity_entity_1.ActivityType.EXERCISE,
                priority: Activity_entity_1.Priority.HIGH,
            ...
            },
            {
                ...
                start_hour: 12.5,
                duration: 0.5,
                type: Activity_entity_1.ActivityType.MEAL,
                priority: Activity_entity_1.Priority.MEDIUM,
            ...
            },
            {
                ...
                start_hour: 14,
                duration: 3,
                type: Activity_entity_1.ActivityType.WORK,
                priority: Activity_entity_1.Priority.HIGH,
            ...
            },
            {
                ...
                start_hour: 8,
                duration: 2,
                type: Activity_entity_1.ActivityType.EVA,
                priority: Activity_entity_1.Priority.HIGH,
                mission: 'EVA-47',
            ...
            },
            {
                ...
                start_hour: 9,
                duration: 2,
                type: Activity_entity_1.ActivityType.OPTIONAL,
                priority: Activity_entity_1.Priority.LOW,
                mission: 'Science',
        ...
        console.log(`   - Activities: ${day1Activities.length + day2Activities.length} (across 2 days)`);
        console.log('\n🔐 Login Credentials:');
